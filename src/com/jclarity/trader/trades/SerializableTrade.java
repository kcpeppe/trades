...
public class SerializableTrade implements Trade, Serializable {
    ...
    public SerializableTrade( Long id,  Date tradeDate, String buySell,  String currency1, BigDecimal amount1, Double exchangeRate, String currency2, BigDecimal amount2, Date settlementDate) {
        this.id = id;
