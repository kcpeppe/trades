...
public class SerializableTradeGenerator extends TradeGenerator {

    final public static String KEY = "serializable";

    public SerializableTradeGenerator() {}

    public String getKey() { return KEY; }
    public String getName() { return "serializable"; }
